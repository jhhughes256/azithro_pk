...
# ------------------------------------------------------------------------------
# Hybrid model standard PK compartments based on:
...
# Tissue and Cellular compartments based on:
...
// Fixed-Effects Parameters (Three Compartment Model)
  ...
  POPVP1F = 2490,  // apparent peripheral volume (fast), L
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
# Compile model 
  mod <- mrgsolve::mcode("HybridZhaZhe_Azithromycin", code)
